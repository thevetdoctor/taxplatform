                    ...
                    <section className="section">
                        ...
                        <div className="section__content">
                            ...
                            <div>
                                ...
                                <p>{userData?.employment_info?.form?.monthAtPreviousEmployer}</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="section">
                        ...
                        <div className="section__content">
                            <div>
                                ...
                                <p> {userData?.banking_info?.form?.checking ? "True" : "False"}</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p>{userData?.banking_info?.form?.savings ? "True" : "False"}</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="terms-wrapper">
                        ...
                        <div className="terms-wrapper__footer">
                            ...
                            <div>
                                ...
                                <p>{userData && dayjs(userData.createdAt).format("dddd, MMMM DD YYYY, hh:mm A")}</p>
                            </div>
                        </div>
                    </section>
                </main>
