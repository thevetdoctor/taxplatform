...
const BankForm = ({
  ...
  const [checking, setChecking] = useState(
    formData && formData.form && formData.form.checking
      ? formData.form.checking
      : false
  );
  const [savings, setSavings] = useState(
    formData && formData.form && formData.form.savings
      ? formData.form.savings
      : false
  );
  const [debitCard, setDebitCard] = useState(
    formData && formData.form && formData.form.debitCard
      ? formData.form.debitCard
      : false
  );
  const [creditCard, setCreditCard] = useState(
    formData && formData.form && formData.form.creditCard
      ? formData.form.creditCard
      : false
  );
  ...
  useEffect(() => {
    // updates form state for editing existing form state  
    if (id !== undefined) {
      console.log({id})
      bankDispatch(formData, dispatch, batch);
    }
  }, [dispatch, formData]);
